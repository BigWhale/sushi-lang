...
<!-- Badge data is published by the `badges` job in .github/workflows/test.yml, which
     holds the Gist id for each repository. The two suites are reported separately: the
     .sushi corpus and the Python unit layer are different things and fail differently. -->
...
[![Sushi tests](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/BigWhale/5bfbd5156dec23acfe18dd7956e251ba/raw/badge_sushi.json)](https://github.com/BigWhale/sushi-lang/actions/workflows/test.yml)
[![Python tests](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/BigWhale/5bfbd5156dec23acfe18dd7956e251ba/raw/badge_python.json)](https://github.com/BigWhale/sushi-lang/actions/workflows/test.yml)
...
ls dist/
# sushi_lang-0.11.1-py3-none-any.whl
```
...
pip install sushi_lang-0.11.1-py3-none-any.whl
...
To create a release:
1. Tag a commit: `git tag v0.11.1`
2. Push the tag: `git push upstream v0.11.1`
