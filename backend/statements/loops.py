...
if TYPE_CHECKING:
    ...
    from semantics.ast import Foreach
...
def _emit_stdin_lines_foreach(
    ...
    from stdlib.src.io.stdio.inline import _emit_readln as _emit_stdin_readln
    from stdlib.src.io.files.inline import _emit_readln as _emit_file_readln
    from stdlib.src.collections.strings_inline import emit_string_is_empty
    from backend.statements import utils
