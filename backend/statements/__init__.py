...
from semantics.ast import Stmt
...
class StatementEmitter:
    ...
    def emit_stmt(self, stmt: Stmt) -> None:
        ...
        match stmt:
            ...
            case Print():
                from backend.statements import io
            ...
            case Break():
                from backend.statements import loops
            ...
            case If():
                from backend.statements import control_flow
            ...
            case Match():
                from backend.statements import matching
