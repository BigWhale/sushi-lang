...
def try_emit_enum_constructor(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall]) -> Optional[ir.Value]:
    ...
    from backend.expressions.calls.utils import get_resolved_type
...
def try_emit_struct_constructor(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall]) -> Optional[ir.Value]:
    ...
    if resolved_type is not None:
        from backend.generics.own import is_builtin_own_method, emit_builtin_own_method
...
def try_emit_stdio_method(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall], to_i1: bool) -> Optional[ir.Value]:
    ...
    from backend.expressions.calls.stdlib import emit_stdlib_stdio_call
    ...
    from stdlib.src.io.stdio import is_builtin_stdio_method
...
def try_emit_file_method(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall], to_i1: bool) -> Optional[ir.Value]:
    ...
    from backend.expressions.calls.stdlib import emit_stdlib_file_call
    ...
    from stdlib.src.io.files import is_builtin_file_method
...
def try_emit_array_method(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall],
    ...
    from backend.types.arrays import is_builtin_array_method, emit_array_method
...
def try_emit_string_method(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall],
    ...
    from backend.expressions.calls.stdlib import emit_stdlib_string_call
    ...
    if expr.method == "is_empty":
        from stdlib.src.collections.strings.compiler import emit_string_is_empty_intrinsic
    ...
    from stdlib.src.collections.strings import is_builtin_string_method
...
def try_emit_primitive_method(codegen: 'LLVMCodegen', expr: Union[MethodCall, DotCall],
    ...
    from backend.expressions.calls.stdlib import emit_stdlib_primitive_call
    ...
    from backend.types.primitives import is_builtin_primitive_method
