...
from backend.types.structs import can_struct_be_hashed, register_struct_hash_method
from backend.types.enums import can_enum_be_hashed, register_enum_hash_method
from backend.types.arrays.methods.hashing import can_array_be_hashed, register_array_hash_method
from semantics.typesys import StructType, EnumType, ArrayType, DynamicArrayType, Type
