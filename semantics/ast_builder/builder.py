...
from semantics.ast_builder.utils.tree_navigation import (
    first as _first,
...
from semantics.ast_builder.utils.expression_discovery import (
...
from semantics.ast_builder.utils.string_processing import (
...
class ASTBuilder:
    ...
    def type_parser(self):
        ...
        if self._type_parser is None:
            from semantics.ast_builder.types.parser import TypeParser
    ...
    def expr_parser(self):
        ...
        if self._expr_parser is None:
            from semantics.ast_builder.expressions.parser import ExpressionParser
    ...
    def stmt_parser(self):
        ...
        if self._stmt_parser is None:
            from semantics.ast_builder.statements.parser import StatementParser
    ...
    def build(self, tree: Tree) -> Program:
        ...
        """
        from semantics.ast_builder.declarations import imports, functions, constants, structs, enums, perks, extensions
    ...
    def _block(self, t: Tree) -> Block:
        ...
        """
        from semantics.ast_builder.statements.blocks import parse_block
