...
from semantics.ast import Expr, Name, BlankLit, MemberAccess, DotCall, TryExpr
...
def expr_atom(atom: Tree | Token, ast_builder: 'ASTBuilder') -> Expr:
    ...
    from semantics.ast_builder.expressions import literals, arrays
...
def expr_call_chain(t: Tree, ast_builder: 'ASTBuilder') -> Expr:
    ...
    from semantics.ast_builder.expressions import calls, members
