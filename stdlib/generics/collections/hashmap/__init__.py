...
from semantics.typesys import BuiltinType, DynamicArrayType
from semantics.generics.types import GenericStructType, TypeParameter
# Import directly from interface module to avoid circular imports
from semantics.generics.providers.interface import MethodSpec
