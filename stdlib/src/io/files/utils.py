...
from stdlib.src.type_definitions import get_basic_types, get_string_type
from stdlib.src._platform import get_platform_module
from backend.platform_detect import get_current_platform
from stdlib.src.string_helpers import fat_pointer_to_cstr
...
def generate_copy(module: ir.Module) -> None:
    ...
    from stdlib.src.libc_declarations import declare_malloc
