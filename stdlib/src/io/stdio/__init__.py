...
def generate_module_ir() -> ir.Module:
    ...
    from stdlib.src.io.stdio.stdin import (
        generate_stdin_readln,
        generate_stdin_read,
        generate_stdin_read_bytes
    )
    from stdlib.src.io.stdio.stdout import (
        generate_stdout_write,
        generate_stdout_write_bytes
    )
    from stdlib.src.io.stdio.stderr import (
        generate_stderr_write,
        generate_stderr_write_bytes
    )
    from stdlib.src.io.stdio.iterators import (
...
def get_builtin_stdio_method_return_type(method_name: str, stdio_type: BuiltinType) -> Type | None:
    ...
    from semantics.typesys import IteratorType, DynamicArrayType
