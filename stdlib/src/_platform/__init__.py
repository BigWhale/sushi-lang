...
def get_platform_module(module_name: str):
    ...
    # Dynamic import: from stdlib.src._platform.{platform_name}.{module_name}
    import importlib
    module_path = f"stdlib.src._platform.{platform_name}.{module_name}"
    ...
    try:
        ...
        raise NotImplementedError(
            ...
            f"Expected: stdlib/src/_platform/{platform_name}/{module_name}.py"
        )
