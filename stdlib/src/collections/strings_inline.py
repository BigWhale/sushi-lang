...
These are emitted directly into the compiled module rather than loaded from stdlib.
...
def emit_strcmp_intrinsic_inline(module: ir.Module) -> ir.Function:
    ...
    """
    from stdlib.src.collections.strings.compiler.strcmp import emit_strcmp_intrinsic
...
def emit_strlen_intrinsic_inline(module: ir.Module) -> ir.Function:
    ...
    """
    from stdlib.src.collections.strings.compiler.strlen import emit_strlen_intrinsic
